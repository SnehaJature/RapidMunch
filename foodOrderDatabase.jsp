...
<title>Food Order Database</title>
</head>
<body>
<%
...
String sql1="insert into food_order1(user_id, total_amt, date,status)values(?,?,?,'pending')";
...
String sql="insert into food_order(user_id, product_id, product_name, quntity, prize, total, date)values(?,?,?,?,?,?,?)";
