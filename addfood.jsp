...
<form action="addfooddatabase.jsp" method="post" enctype="multipart/form-data" >
...
<legend><strong><label>Add Food</strong></label></legend>
<b> <label>Food Name</b></label><br>
<input type="text" placeholder="Enter Food Name" id="name" name="name", class="form-control"><br>
