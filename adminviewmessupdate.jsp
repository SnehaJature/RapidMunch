...
<title>admin view mess update</title>
</head>
<body>
<jsp:include page="adminheader.jsp"></jsp:include>
<fieldset><legend><b><center>Mess Delivery Update</center></b></legend></fieldset>
...
<form action="adminviewmessupsubmit.jsp" method="post" enctype="Multipart/form-data" class="form-horizental">
<% 
...
<input type="hidden" value="<%=rs.getString(1)%>" NAME="id">
 Name:<input type="text" value="<%=rs.getString(2)%>" class="form-control" name="Name" id="name"><br>
...
<input type="submit" value="submit" class="btn btn-success block" onclick="return myfunction()">
<%}%>
